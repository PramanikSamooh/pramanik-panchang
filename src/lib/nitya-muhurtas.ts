...
export const NITYA_MUHURTAS: NityaMuhurtaSpec[] = [
  ...
  { number:  9, nameHi: "सुतमुखी",       nameEn: "Sutamukhi",   baseClass: "shubh",
    doHi: "यात्रा, नेटवर्किंग",                doEn: "Travel, networking",
    dontHi: "अधिक वादे",                       dontEn: "Excess promises" },
  { number: 10, nameHi: "पुरुहूत",       nameEn: "Puruhuta",    baseClass: "ashubh",
  ...
  { number: 12, nameHi: "नक्तंकरा",     nameEn: "Naktankara",  baseClass: "ashubh",
    doHi: "विश्राम, रख-रखाव",                  doEn: "Rest, maintenance",
    dontHi: "सार्वजनिक आयोजन",                 dontEn: "Public events" },
  { number: 13, nameHi: "वरुण",         nameEn: "Varuna",      baseClass: "shubh",
    doHi: "शुद्धिकरण, जल कार्य",                doEn: "Purification, water rites",
    dontHi: "चुगली",                            dontEn: "Gossip" },
  // Aryaman: शुभ default, अशुभ on Sunday (0)
  { number: 14, nameHi: "अर्यमन्",      nameEn: "Aryaman",     baseClass: "shubh",
  ...
  { number: 15, nameHi: "भग",           nameEn: "Bhaga",       baseClass: "ashubh",
  ...
  { number: 17, nameHi: "अजपाद",        nameEn: "Ajapaada",    baseClass: "ashubh",
    doHi: "परीक्षण, लेखा-जोखा",                 doEn: "Testing, accounting",
    dontHi: "यात्रा, शल्यक्रिया",                dontEn: "Travel, surgery" },
  { number: 18, nameHi: "अहिर्बुध्य",   nameEn: "Ahirbudhya",  baseClass: "shubh",
  ...
  { number: 23, nameHi: "विधातृ",        nameEn: "Vidhatr",     baseClass: "shubh",
  ...
  { number: 28, nameHi: "द्युमद्द्युति", nameEn: "Dyumadyuti",  baseClass: "shubh",
